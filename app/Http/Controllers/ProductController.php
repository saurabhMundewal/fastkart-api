...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return  $products = $product->latest('created_at')->paginate($request->paginate);
           // return ProductResource::make($products)->withSensitiveAttributes(true);
   ...
   public function getProductsByIDRange($id)
    {
        return $this->repository->getProductByID($id);
        // Calculate the upper limit of the ID range
        // $endId = $id + 5;

        // // Retrieve products within the ID range
        // $products = Product::whereBetween('id', [$id, $endId])->get();
