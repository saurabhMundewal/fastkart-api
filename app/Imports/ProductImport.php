    ...
    */
    ...
    public function rules(): array
    {
        return [
            ...
            'watermark_position' =>  ['min:0', 'max:1'],
    ...
    {         
        ...
        try {
            ...
            // if (
            //     $row['type'] == 'simple' && isset($row['is_licensable']) &&
            //     !$row['is_licensekey_auto'] && $row['license_key']
            // ) {
            //     $license_keys = Helpers::explodeLicenseKeys($row['separator'], $row['license_key']);
            //     $product = $this->updateOrCreateProductLicenseKeys($product, $license_keys);
            // }

            // if ($row['wholesale_prices']) {
            //     $product = $this->updateOrCreateWholesaleProduct($product, $row['wholesale_prices']);
            //     $product->wholesales;
            // }
