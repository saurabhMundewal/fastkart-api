            ...
            'moscow' => [
                'content' => [
                    'home_banner' => [
                        'status' => true,
                        'main_banner' => [
                            'image_url' => $this->baseURL.'/frontend/images/themes/moscow/1.jpg',
                            'redirect_link' => [
                                'link' => '',
                                'link_type' => 'collection',
                                'product_ids' => null
                    ...
                    'coupons' => [
                        'status' => true,
                        'image_url' => $this->baseURL.'/frontend/images/themes/moscow/2.jpg',
                        'redirect_link' => [
                            'link' => '',
                            'link_type' => 'collection',
                            'product_ids' => null
            ...
            'cairo' => [
                'content' => [
                    'home_banner' => [
                        'status' => true,
                        'main_banner' => [
                            'image_url' => $this->baseURL.'/frontend/images/themes/cairo/digital-bg.jpg',
                    ...
                    'slider_product' => [
                        'image_url' => $this->baseURL.'/frontend/images/themes/cairo/digi-bg-2.jpg',
                        'title' => 'Featured Templates',
